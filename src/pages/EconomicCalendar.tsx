                ...
                {extraProducts.map(product => (
                  <li key={product.label}>
                    <button className="group w-full flex items-center gap-3 px-3 py-2 rounded-xl text-muted-foreground hover:text-foreground transition-all relative">
                      ...
                      <div className={`relative z-10 w-7 h-7 rounded-lg bg-gradient-to-br ${product.bg} border border-border/50 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-200`}>
                      ...
                      <span className={`relative z-10 text-[9px] font-bold px-1.5 py-0.5 rounded-full border flex-shrink-0 ${
                        product.badge === "Included" || product.badge === "Live"
